...
XGBoost: ROC-AUC 0.855, Recall 0.71, Precision 0.23

The Random Forest performs best, so I used it as my final model.
...
# Tools Used:
Python, Pandas, NumPy, Scikit-learn, XGBoost, SHAP, Matpoltlib, Seaborn
